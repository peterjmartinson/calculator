...
output += '  <figure class="first-image">';
...
output += '  <figure class="second-image">';
...
output += '    </ol>';
output += '    <p>The concept of Golden Ages is only one of Seilacher\'s many contributions to not just paleontology, but to Man\'s understanding of his place in the universe.  The rocks may now have his bones, but his ideas are ours.</p>';
